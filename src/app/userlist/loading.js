"use client"
import style from '@/app/userlist/loading.module.css'
        ...
        <div className="grid grid-cols-12 gap-4">
          {
            [...new Array(20)].map((index) => (
              <div key={index} className="col-span-12 sm:col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-3 2xl:col-span-2 shadow-lg border-2 rounded-lg">
